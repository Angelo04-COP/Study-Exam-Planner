...
// Sostituiamo il router con la prop nativa 'navigation' ricevuta dal Navigator (slide pag. 14)
export default function AddScreen({ navigation }: { navigation: any }) {
  ...
  // Sostituiamo router.replace con il metodo nativo .navigate() (slide pag. 14)
  const chiudiPopUp = () => {
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.popupContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setModalVisibile(false);
                // Navigazione verso la rotta dello Stack (slide pag. 14)
                navigation.navigate('AddCorso'); 
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setModalVisibile(false);
                // Navigazione verso lo schermo dell'esame
                navigation.navigate('AddEsame'); 
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setModalVisibile(false);
                // Navigazione diretta verso lo schermo ponte che apre il modal del tuo amico
                navigation.navigate('AddScelta'); 
              }}
            >
...
// I tuoi stili grafici rimangono esattamente identici
