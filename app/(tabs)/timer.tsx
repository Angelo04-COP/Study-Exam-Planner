...
import { mockAttivita, mockSessioni, mockStoricoTimer } from '../../src/constants/mockData';
...
export default function TimerScreen() {
  ...
  // STATO CHIAVE: Ricorda quanti secondi c'erano quando hai iniziato un'attività specifica
  ...
  const [history, setHistory] = useState<LogTimer[]>(() => {
    ...
    return mockStoricoTimer.map((item: any) => { 
      ...
      // Controllo di sicurezza: se i minuti non esistono o non sono un numero, usa 0
  ...
  // Funzione che salva nello storico
...
const styles = StyleSheet.create({
  ...
  // Larghezze fisse per i pulsanti
  ...
  historyCard: { 
    ...
    borderLeftWidth: 4, // Indicatore laterale pulito senza View aggiuntive
